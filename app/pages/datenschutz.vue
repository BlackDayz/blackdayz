<template>
    <div>
        ...
        <p>
            ...
            für BlackDayz. Eine Nutzung der Internetseiten von BlackDayz ist grundsätzlich ohne jede Angabe personenbezogener
            Daten möglich. Sofern eine betroffene Person besondere Services unseres Unternehmens über unsere Internetseite in
        ...
        <p>
            ...
            Übereinstimmung mit den für die BlackDayz geltenden landesspezifischen Datenschutzbestimmungen. Mittels dieser
        ...
        <br>
        <p>
            Die BlackDayz hat als für die Verarbeitung Verantwortlicher zahlreiche technische und organisatorische Maßnahmen
        ...
        <br>
        <h4 class="text-3xl text-center my-10 font-bold">
            1. Begriffsbestimmungen
        </h4>
        <p>
            Die Datenschutzerklärung der BlackDayz beruht auf den Begrifflichkeiten, die durch den Europäischen Richtlinien-
        ...
        <br>
        <p>Benedikt Sauer</p>
        <p>Obertorstraße 12</p>
        <p>53340 Meckenheim</p>
        <p>Deutschland</p>
        <p>Tel.: +4915110842428</p>
        <p>E-Mail: info[at]blackdayz.de</p>
        <p>Website: www.blackdayz.de</p>
        <br>
        ...
        <p>
            Die Internetseiten der BlackDayz verwenden Cookies. Cookies sind Textdateien, welche über einen Internetbrowser
        ...
        <br>
        <p>
            Durch den Einsatz von Cookies kann die BlackDayz den Nutzern dieser Internetseite nutzerfreundlichere Services
        ...
        <p>
            Die Internetseite der BlackDayz erfasst mit jedem Aufruf der Internetseite durch eine betroffene Person oder ein
        ...
        <br>
        <p>
            Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die BlackDayz keine Rückschlüsse auf die
            ...
            BlackDayz daher einerseits statistisch und ferner mit dem Ziel ausgewertet, den Datenschutz und die
        ...
        <ul>
            ...
            <li>
                ...
                <p>
                    ...
                    Daten, die bei der BlackDayz gespeichert sind, veranlassen möchte, kann sie sich hierzu jederzeit an einen
                    Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der BlackDayz wird veranlassen,
                    dass dem Löschverlangen unverzüglich nachgekommen wird.
                </p>
                <br>
                <p>
                    Wurden die personenbezogenen Daten von der BlackDayz öffentlich gemacht und ist unser Unternehmen als
                    Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten verpflichtet, so trifft
                    die BlackDayz unter Berücksichtigung der verfügbaren Technologie und der Implementierungskosten angemessene
                    ...
                    die Verarbeitung nicht erforderlich ist. Der Mitarbeiter der BlackDayz wird im Einzelfall das Notwendige
                    veranlassen.
                </p>
            </li>
            <br>
            <li>
                ...
                <p>
                    ...
                    personenbezogenen Daten, die bei der BlackDayz gespeichert sind, verlangen möchte, kann sie sich hierzu
                    jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der BlackDayz
            ...
            <li>
                ...
                <p>
                    ...
                    Mitarbeiter der BlackDayz wenden.
                </p>
                <br>
            </li>
            <li>
                ...
                <br>
                <p>
                    Die BlackDayz verarbeitet die personenbezogenen Daten im Falle des Widerspruchs nicht mehr, es sei denn, wir
                ...
                <br>
                <p>
                    Verarbeitet die BlackDayz personenbezogene Daten, um Direktwerbung zu betreiben, so hat die betroffene Person
                    ...
                    Widerspricht die betroffene Person gegenüber der BlackDayz der Verarbeitung für Zwecke der Direktwerbung, so
                    wird die BlackDayz die personenbezogenen Daten nicht mehr für diese Zwecke verarbeiten.
                </p>
                <br>
                <p>
                    Zudem hat die betroffene Person das Recht, aus Gründen, die sich aus ihrer besonderen Situation ergeben,
                    gegen die sie betreffende Verarbeitung personenbezogener Daten, die bei der BlackDayz zu wissenschaftlichen
                ...
                <p>
                    ...
                    BlackDayz oder einen anderen Mitarbeiter wenden. Der betroffenen Person steht es ferner frei, im Zusammenhang
            ...
            <li>
                ...
                <p>
                    ...
                    Person, trifft die BlackDayz angemessene Maßnahmen, um die Rechte und Freiheiten sowie die berechtigten
        ...
        <br>
        <h4 class="text-3xl text-center my-10 font-bold">
            10. Gesetzliche oder vertragliche Vorschriften zur Bereitstellung der personenbezogenen Daten; Erforderlichkeit
        ...
        <p>
            ...
            der personenbezogenen Daten gesetzlich oder vertraglich vorgeschrieben oder für den Vertragsabschluss erforderlich
        ...
        <br>
        <p>
            Entwickelt von den <a href="https://willing-able.com/">LegalTech</a> Spezialisten von Willing & Able, die auch das
            System für <a href="https://abletocontract.com/">digitale Verträge</a> entwickelt haben. Die Texte des
            Datenschutzerklärungs-Generators wurden von <a href="https://dg-datenschutz.de/">Prof. Dr. h.c. Heiko Jonny
                Maniero</a> und Rechtsanwalt <a
                href="https://www.wbs.legal/"
                rel="nofollow"
            >Christian Solmecke</a> erstellt und
            publiziert.
        </p>
    </div>
</template>
