    ...
    ui: {
      ...
      button: {
        color: {
          ...
          secondary: {
            solid: 'grid text-center text-primary bg-gray-500 shadow-blackdayz-secondary-shadow px- 12 hover:bg-gray-400 hover:shadow-blackdayz-secondary-shadow-hover hover:-translate-x-1 hover:-translate-y-1 transition-all duration-200',
          },
        },
        inline: 'grid'
      }
